...
public class MTDCoupon extends javax.swing.JDialog {
    ...
    public MTDCoupon(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("รายงานส่วนลดบัตรคูปองพิเศษ (MTD Coupon Report)");
   ...
   // dcd.showDialog(new LookAndFeelFrame(), true, point);
    ...
    public void bntOKClick() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "กรุณาป้อนวันที่ให้ถูกต้อง (Format=dd/MM/yyyy EXP 01/01/2009)");
        }
    }
        ...
        if (!Value.getComPort().equals("NONE")) {
            if (prn.OpenPrint(Value.getComPort())) {
                ...
                try {
                    ...
                    String SqlQuery = "select s_cupon.cucode,sum(cuquan),sum(cuamt),cupon.cuname from s_cupon left join cupon on s_cupon.cucode=cupon.cucode " +
                                      "where (s_date>='" + Datefmt.format(TDate1) + "') and (s_date<='" + Datefmt.format(TDate2) + "') group by s_cupon.cucode order by s_cupon.cucode";
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MTDCoupon dialog = new MTDCoupon(new javax.swing.JFrame(), true);
