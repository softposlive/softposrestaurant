...
public class MTDholdtablerep extends javax.swing.JDialog {
    ...
    public MTDholdtablerep(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(java.awt.Color.lightGray, 2), "รหัสพนักงานขาย (Cashier)", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Norasi", 0, 16))); // NOI18N
    ...
    public void ProcessProc() {
        ...
        if (!Value.getComPort().equals("NONE")) {
            if (prn.OpenPrint(Value.getComPort())) {
                ...
                prn.print("        (MTD Hold Table Report)");
                ...
                try {
                    ...
                    String SqlQuery = "select *from s_tran left join s_invoice on r_refno=b_refno and macno=b_macno  where (s_tran.s_date>='"+Datefmt.format(TDate1)+"') and (s_tran.s_date<='"+Datefmt.format(TDate2)+"') and (Holdcashier>='"+CashNo1+"') and (Holdcashier<='"+CashNo2+"') and (HoldTable='Y') order by s_tran.s_date,macno,CONCAT(macno,R_refno),R_Table,Holdcashier,Holdtime";
                   ...
                   rec.first();
                    ...
                    if (rec.getRow() == 0) {
                        ...
                        do {
                             if (!TempDate.equals(DatefmtShow.format(rec.getDate("stran.s_date")))) {
                                TempDate = DatefmtShow.format(rec.getDate("s_tran.s_date")) ;
