...
public class PaidoutFrm extends javax.swing.JDialog {
    ...
    /**
     * Creates new form paidoutfrm
     */
    public PaidoutFrm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void SaveDataPaidout() {
        ...
        if(Value.useprint){
            if(Value.printdriver){
                ...
                pd.addText(St + " " + "Cashier:" + PublicVar._User + " Mac:" + Value.MACNO);
                pd.addText("----------------------------------------");
                pd.addText("จำนวนเงินนำออกจากลิ้นชัก " + PUtility.DataFull(Decfmt.format(PaidoutAmt), 12));
                pd.addText("----------------------------------------");
                pd.addText("");
                pd.addText("REG ID :" + Value.MACNO);
                pd.addText("");
                pd.printHTML();                        
        ...
        try {
            String SQLQuery = "insert into paidiofile "
                    ...
                    + "'"+PublicVar._User+"','"+Value.MACNO+"',"
                    + "'O','"+PaidinAmt+"','"+PaidoutAmt+"')";
            MySQLConnect.exeUpdate(SQLQuery);                
        } catch (Exception e) {
