...
public class CustomerCountDialog extends javax.swing.JDialog {
    ...
    public CustomerCountDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtAmount, javax.swing.GroupLayout.PREFERRED_SIZE, 318, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CustomerCountDialog dialog = new CustomerCountDialog(new javax.swing.JFrame(), true);
    ...
    private void input(String inp) {
        ...
        txtAmount.setText(temp+inp);
        txtAmount.requestFocus();
    }

    private void SaveDataPaidin() {
        String custCount = txtAmount.getText();
        custCountTotal = Integer.parseInt(custCount);
        dispose();
    }
}
